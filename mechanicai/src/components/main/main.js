...
//     const sectionLabels = ['Diagnosis', 'Instructions', 'Tools Required', 'Parts Replaced', 'Safety Tips', 'Confirmations'];
...
//           if (currentSection) {
//             parsedResponse.push({ section: currentSection, content: currentContent });
//           }
...
//         const formattedResponse = parseBotResponse(response.data.response || '');
//         setMessages((prevMessages) => [
//           ...prevMessages,
...
//     if (message.text && message.text instanceof Object) {
//       const sections = message.text;
  
//       return sections.map((section, index) => (
//         <div key={index} style={{ marginBottom: '20px' }}>
//           <h4>{section.heading}:</h4> {/* Section heading */}
//           {section.type === 'list' ? (
...
//             </ol>
//           ) : (
//             <p>{section.content}</p> // Single paragraph for non-list sections like Diagnosis
//           )}
//         </div>
//       ));
//     } else {
...
//           {renderMessageContent(message)} {/* Render structured content */}
//         </div>
//       </div>
//     ))}
//   </div>
